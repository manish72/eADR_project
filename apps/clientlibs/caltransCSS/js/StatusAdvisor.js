...
function statusCheckAdvisor(currStatus, meetDate, meetingType, disputeID, actualData, data) {
    ...
    let curstatusObj = {
        ...
        "advisor requested additional information from re": "advisor requested additional information from re",
        "advisor requested additional information from contractor": "advisor requested additional information from contractor",
        "advisor requested additional information from re and contractor": "advisor requested additional information from re and contractor",
    ...
    //below is for status present in curstatusObj object
        ...
        if (currStatus.toLowerCase()in recomAfterSubObj) {
            ...
            if ((currStatus.toLowerCase()) !== "advisor submitted the recommendation report") {
                ...
                if ((currStatus.toUpperCase()) === "RE Requested Clarification".toUpperCase()) {
                    ...
                    setTimeout(function alertFunc2() {
                        if (errorHandler === "" || errorHandler == null) {
                            ...
                            else if (currStatus.toUpperCase() === "Advisor Responded to Reconsideration Request".toUpperCase() || currStatus.toUpperCase() === "Final Report Generated".toUpperCase() || currStatus.toUpperCase() === "Document has been signed".toUpperCase()) {
                                //guideBridge.resolveNode("ChairorAdvisorPanel.RequestReconsiderPanelRecChair").visible = true;
                                //guideBridge.resolveNode("ChairorAdvisorPanel.RequestReconsiderPanelRecChair").enabled = true;
                                //guideBridge.setFocus(guideBridge.resolveNode("ChairorAdvisorPanel.RequestReconsiderPanelRecChair")).somExpression;
