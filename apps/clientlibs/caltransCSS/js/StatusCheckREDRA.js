...
function statusCheckREDRA(currStatus,meetingType,disputeID,actualData,pendingAction,duedate){
        let errorHandler;
		...
		else if (currStatus.toLowerCase() === "Advisor requested Additional Information from Contractor".toLowerCase() || currStatus.toLowerCase() === "Contractor submitted additional information".toLowerCase()) {
			guideBridge.resolveNode("REPanel.ReqClariPPRES").visible = false;
            guideBridge.resolveNode("REPanel.ResponseRecomPPRES").visible = false;
            guideBridge.resolveNode("REPanel.ReqResPanelPPRES").visible = false;
            guideBridge.resolveNode("REPanel.AddInfoSecPPRES").visible = false;
		...
		else if (currStatus.toLowerCase() === "Advisor submitted the Recommendation Report".toLowerCase()||currStatus.toLowerCase() === "Contractor Requested Clarification".toLowerCase()) {
        ...
        else if (currStatus.toLowerCase() === "RE Requested Clarification".toLowerCase() || currStatus.toLowerCase() === "RE and Contractor Requested Clarification".toLowerCase() || currStatus.toLowerCase() === "Advisor submitted Clarification Request".toLowerCase() || currStatus.toLowerCase() === "Contractor Submitted Recommendation Response".toLowerCase()) {
            guideBridge.resolveNode("REPanel.ReqClariPPRES").visible = true;
            guideBridge.resolveNode("REPanel.ReqClariPPRES").enabled = true;
            guideBridge.resolveNode("REPanel.ReqClariPPRES.button_12852821241680595402538").visible = false;
    	...
    	// below is for Status 23 or 25 or 27 or 29 or 30
		else if (currStatus.toLowerCase() === "RE Submitted Recommendation Response".toLowerCase()||currStatus.toLowerCase() === "RE and Contractor Submitted Recommendation Response".toLowerCase() || currStatus.toLowerCase() === "Contractor Requested Reconsideration".toLowerCase() || currStatus.toLowerCase() === "RE Requested Reconsideration".toLowerCase() || currStatus.toLowerCase() === "Advisor Responded to Reconsideration Request".toLowerCase() || currStatus.toLowerCase() === "Final Report Generated".toLowerCase() || currStatus.toLowerCase() === "Document has been signed".toLowerCase()) {
			guideBridge.resolveNode("REPanel.ReqClariPPRES").visible = true;
            guideBridge.resolveNode("REPanel.ReqClariPPRES").enabled = true;
            guideBridge.resolveNode("REPanel.ReqClariPPRES.button_12852821241680595402538").visible = false;
            guideBridge.resolveNode("REPanel.ReqClariPPRES.ReqClarifyInputPPRES").enabled = false;
            ...
            setTimeout(function alertFunc3() {
                if(errorHandler===""||errorHandler==null){
                    ...
                    if(currStatus.toLowerCase() === "RE Requested Reconsideration".toLowerCase()|| currStatus.toLowerCase() === "Advisor Responded to Reconsideration Request".toLowerCase() || currStatus.toLowerCase() === "Final Report Generated".toLowerCase() || currStatus.toLowerCase() === "Document has been signed".toLowerCase()){
						let reconsiderData;
