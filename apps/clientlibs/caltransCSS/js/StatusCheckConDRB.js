...
function statusCheckConChair(currStatus,meetingType,disputeID,actualData,pendingAction,duedate){
    let errorHandler;
    ...
    else if (currStatus.toLowerCase() === "Chair requested Additional Information from RE".toLowerCase() || currStatus.toLowerCase() === "RE submitted additional information".toLowerCase()) {
		guideBridge.resolveNode("ContractorPanel.ReqClariPPCon").visible = false;
        guideBridge.resolveNode("ContractorPanel.ResponseRecomPPCon").visible = false;
        guideBridge.resolveNode("ContractorPanel.ReqResPanelPPCon").visible = false;
        guideBridge.resolveNode("ContractorPanel.AddInfoSecPPCon").visible = false;
    ...
    else if (currStatus.toLowerCase() === "Chair submitted the Recommendation Report".toLowerCase()||currStatus.toLowerCase() === "RE Requested Clarification".toLowerCase()) {
    ...
    else if (currStatus.toLowerCase() === "Contractor Requested Clarification".toLowerCase() || currStatus.toLowerCase() === "RE and Contractor Requested Clarification".toLowerCase() || currStatus.toLowerCase() === "Chair submitted Clarification Request".toLowerCase() || currStatus.toLowerCase() === "RE Submitted Recommendation Response".toLowerCase()) {
        guideBridge.resolveNode("ContractorPanel.ReqClariPPCon").visible = true;
        guideBridge.resolveNode("ContractorPanel.ReqClariPPCon").enabled = true;
        guideBridge.resolveNode("ContractorPanel.ReqClariPPCon.button_12852821241680595402538").visible = false;
    ...
    // below is for Status 24 or 25 or 26 or 29 or 30
    else if (currStatus.toLowerCase() === "Contractor Submitted Recommendation Response".toLowerCase() || currStatus.toLowerCase() === "RE and Contractor Submitted Recommendation Response".toLowerCase() || currStatus.toLowerCase() === "RE Requested Reconsideration".toLowerCase()|| currStatus.toLowerCase() === "Contractor Requested Reconsideration".toLowerCase() || currStatus.toLowerCase() === "Chair Responded to Reconsideration Request".toLowerCase() || currStatus.toLowerCase() === "Final Report Generated".toLowerCase() || currStatus.toLowerCase() === "Document has been signed".toLowerCase()) {
        guideBridge.resolveNode("ContractorPanel.ReqClariPPCon").visible = true;
        guideBridge.resolveNode("ContractorPanel.ReqClariPPCon").enabled = true;
        guideBridge.resolveNode("ContractorPanel.ReqClariPPCon.button_12852821241680595402538").visible = false;
        guideBridge.resolveNode("ContractorPanel.ReqClariPPCon.ReqClarifyInputPPCon").enabled  = false;
        ...
        setTimeout(function alertFunc3() {
            if(errorHandler===""||errorHandler==null){
                ...
                if(currStatus.toLowerCase() === "Contractor Requested Reconsideration".toLowerCase() || currStatus.toLowerCase() === "Chair Responded to Reconsideration Request".toLowerCase() || currStatus.toLowerCase() === "Final Report Generated".toLowerCase() || currStatus.toLowerCase() === "Document has been signed".toLowerCase()){
